...
@Component({
  selector: 'app-marketing-sales-funnel-original-story',
  standalone: true,
  imports: [CommonModule, MatDialogModule, MatIconModule],
  templateUrl: './marketing-sales-funnel-original-story.component.html',
  styleUrls: [
    './marketing-sales-funnel-story.component.css',
    './marketing-sales-funnel-story-visit-conversion.component.css',
  ],
})
export class MarketingSalesFunnelOriginalStoryComponent {
    ...
    return [
      {
        ...
        value: this.formatPercent(
          this.safeRatio(summary.visits_iventas, summary.leads_meta),
        ),
      },
      {
