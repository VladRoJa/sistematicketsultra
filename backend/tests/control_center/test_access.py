...
def test_manager_resolves_fixed_branch_scope():
    access = resolve_control_access(
...
def test_regional_single_region_resolves_region_scope(load_regions):
...
@patch("app.control_center.access._load_region_keys_by_branch")
def test_regional_mixed_assignments_resolves_branch_pool(load_regions):
    load_regions.return_value = {
        1: ("MXL_SL",),
        2: ("MXL_SL",),
        20: ("TIJ_COSTA",),
...
@patch("app.control_center.access._load_region_keys_by_branch")
def test_regional_cannot_request_global_scope(load_regions):
    load_regions.return_value = {
        1: ("MXL_SL",),
        2: ("MXL_SL",),
    }
