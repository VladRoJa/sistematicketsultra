...
EXPORT_HEADERS = (
    "ID socio", "PIN", "ID folio", "Nombre", "Email", "Sucursal", "Fecha de venta",
...
def build_members_export(items: list[dict]) -> BytesIO:
    ...
    for item in items:
        worksheet.append((
            ...
            item["member_name"], item["email"], item["branch_name"], item["sale_date"],
    ...
    widths = (18, 14, 18, 28, 30, 22, 14, 18, 18, 14, 14, 24, 20, 18, 18, 16)
